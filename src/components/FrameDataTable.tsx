...
export const FrameDataTable: React.FC = () => {
    ...
    const [deployTimestamp, setDeployTimestamp] =
                ...
                try {
                    ...
                    const processMove = (
                        ...
                        return {
                            ...
                            Stance: intern(
                                moveObject.Stance
                                    ? String(moveObject.Stance)
                                    : null,
                            ),
                            HitLevel: intern(
                                moveObject.HitLevel
                                    ? String(moveObject.HitLevel)
                                    : null,
                            ),
                            Impact:
                                moveObject.Impact != null
                                    ? Number(moveObject.Impact)
                                    : 0,
                            Damage: intern(
                                moveObject.Damage != null
                                    ? String(moveObject.Damage)
                                    : null,
                            ),
                            DamageDec:
                                moveObject.DamageDec != null
                                    ...
                                    : null,
                            Block: intern(
                                moveObject.Block != null
                                    ? String(moveObject.Block)
                                    : null,
                            ),
                            BlockDec:
                            ...
                            Hit: intern(
                                moveObject.Hit != null
                                    ? String(moveObject.Hit)
                                    : null,
                            ),
                            HitDec:
                                moveObject.HitDec != null
                                    ? Number(moveObject.HitDec)
                                    : null,
                            HitString: intern(
                                moveObject.Hit != null
                                    ? String(moveObject.Hit)
                            ...
                            GuardBurst:
                                moveObject.GuardBurst != null
                                    ...
                                    : null,
                            Notes: intern(
                                moveObject.Notes != null
                                    ? String(moveObject.Notes)
                                    : null,
                            ),
                        } as Move;
                    };
                        ...
                        for (const id of ids) {
                            ...
                            if (Array.isArray(data)) {
                                ...
                                for (let i = 0; i < data.length; i++) {
                                    tempMoves.push(
                                        processMove(data[i], id, charName),
                                    );
                                }
                            }
                        }
        ...
        (
            ...
            switch (fieldId) {
                ...
                case "impact":
                    return {
                        string:
                            move.Impact != null ? String(move.Impact) : null,
                ...
                case "guardBurst":
                    return {
                        string:
                            move.GuardBurst != null
                                ? String(move.GuardBurst)
                                : null,
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            >
                                <CardTitle className="flex items-center">
                                    {selectedCharacterNameFromContext ||
                                        "Character"}{" "}
                                    Frame Data
                                    <ChevronRight
                                        className={cn(
